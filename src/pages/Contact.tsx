...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!supabase) {
      ...
      setErrorMessage('Database connection not configured. Please connect to Supabase first.');
    ...
    try {
      ...
      // Even if the email notification fails, we've stored the message
      try {
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <a href="tel:1-800-SOULTEC" className="text-purple-400 hover:text-purple-300">
                        (502) 236-2557
                      </a>
                    </div>
                  </div>
